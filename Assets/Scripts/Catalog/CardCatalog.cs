...
namespace BannerOfBones.CardGame
{
    ...
    public static class CardCatalog
    {
        ...
        private static CardData CreateChainLightning()
        {
            ...
            card.description = "Deal 2 damage to every enemy for each pair rolled.";
            card.energyCost  = 1;
            card.duration    = ECardDuration.Instant;
            card.targetsAllEnemies = true;
            card.effects = new List<CardEffectData>
        ...
        private static CardData CreateWarDrums()
        {
            ...
            card.description = "Reroll all of your dice. Then deal 1 damage to each enemy for every unique value in the new roll.";
            card.energyCost  = 2;
            card.duration    = ECardDuration.Instant;
            card.targetsAllEnemies = true;
            card.effects = new List<CardEffectData>
